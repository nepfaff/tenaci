...
%define satrt and end locations here
startX = [0, 0, 0, 0]
...
jointspace_sim(startX, startY, startZ, startTheta, endX, endY, endZ, endTheta, timeForTrajectory, samplePeriod)

function plot = jointspace_sim(startX, startY, startZ, startTheta, endX, endY, endZ, endTheta, timeForTrajectory, samplePeriod)
    plot3([0 0], [0 0], [0 0])
    xlabel('X')
    ylabel('Y')
    zlabel('Z')

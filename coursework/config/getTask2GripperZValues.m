...
%GETTASK2GRIPPERZVALUES
    ...
    % base-plate
    GRIPPER_Z_PICK_UP_CUBE_FACING_DOWN = 0.035;%0.054;
    GRIPPER_Z_ABOVE_CUBE_PICK_UP_FACING_DOWN = 0.07;%0.08;
    
    GRIPPER_Z_PICK_UP_CUBE_FACING_STRAIGHT = 0.0275;%0.04;
    GRIPPER_Z_ABOVE_CUBE_PICK_UP_FACING_STRAIGHT = 0.07;%0.08;
    ...
    GRIPPER_PICK_DOWN_OFFSET = 0.016;
end

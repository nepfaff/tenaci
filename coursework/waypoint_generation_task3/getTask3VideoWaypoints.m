...
%video specific drawing. The waypoints don't include the start pose.
    ...
    penAbovePickUp1.timeForTrajectory = 0.5;
    ...
    line1Above.timeForTrajectory = 0.5;
    line1Above.name = "Above line 1 start";

    line1Start.x = -0.06;
    line1Start.y = 0.2;
    line1Start.z = drawingHeight;
    line1Start.timeForTrajectory = 0.2;
    ...
    line3End.timeForTrajectory = 0.45;
    ...
    for i = 1 : length(arcWaypoints)
        ...
        % Directly group to last line point as otherwise we have a 1.4s delay before starting arc
        arcWaypoints(i).groupToPrevious = true;
        arcWaypoints(i).timeForTrajectory = 1.4;
    ...
    aboveArcEnd.timeForTrajectory = 0.25;
